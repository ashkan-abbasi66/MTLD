...
% % addpath('E:\THESIS\Implements\Pedagogical\BEST ROUTINES\matlabPyrTools\MEX')
% % addpath('E:\THESIS\Implements\Pedagogical\BEST ROUTINES\matlabPyrTools\')

addpath('./Simoncelli_PyrTools_2')
% addpath(genpath('E:\THESIS\Implements\rwt-master'))
addpath('./Added_PyrTools')
addpath('./denoising_subprograms')
addpath('./images')
