function [w, s_out] = iuwt(im, levels)
...
%   IM = SUM(W, 3) + S;
%
% The original function was found here:
%   Bankhead, Peter, et al. "Fast retinal vessel detection and measurement 
%   using wavelets and edge location refinement." 
%   PloS one 7.3 (2012): e32435.
%
%
