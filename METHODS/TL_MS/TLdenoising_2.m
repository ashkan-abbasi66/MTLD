function [Iss_tl,paramsout,runtime] = TLdenoising_2(imn,sigma,n,sparsity_controller)
% This function calls "TSPCLOSEDFORMdenoising_2"
%
% See "TLdenoising.m"
%
...
runtime = cputime;
[Iss_tl,paramsout]= TSPCLOSEDFORMdenoising_2(imn,paramsin); %IMU is the output denoised image
