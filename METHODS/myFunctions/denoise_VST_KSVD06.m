function [img_denoise, time] = denoise_VST_KSVD06(img_raw)
    ...
    dictsize = RR*blocksize^2; % number of atoms in the dictionary
    IterNum = numIterOfKsvd;
    [D, ~] = ksvd_denoising(fz*255, sigma_den*255,blocksize,dictsize,IterNum);
%     [D, ~] = ksvd_denoising_noClip(fz*255, sigma_den*255,blocksize,dictsize,IterNum);
