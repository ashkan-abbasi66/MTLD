function [img_denoise, runtime,tl_direct] = denoise_VST_TLD(img_raw,sparsity_controller)
    ...
    n = 121;
    [tl_direct,~,runtime_iss] = TLD_2(fz*255,sigma_den*255,n,sparsity_controller);  
    ...
    runtime = time_part1 + time_part2 + runtime_iss;
