...
%     if sigma_den>0.15
%         sparsity_controller = 0.7;
%     end
    sigma_den = sigma_den*0.9;
    ...
    vst_time = cputime - vst_time;
    
    [out_ms_tl,runtime_ms] = TLdenoising_MS(fz*255,sigma_den*255,n,Ns,wname,verbose,sparsity_controller);
    ...
    vst_time_2 = cputime - vst_time_2;
    vst_time_2 = vst_time_2 + vst_time;
    
    time.overall = vst_time_2 + runtime_ms.overall;
    time.ANh = vst_time_2 + runtime_ms.ANh;
